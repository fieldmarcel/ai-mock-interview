...
const Homepage = () => {
  return (
    <div className=" text-black font-sans min-h-screen">
      ...
      <div className="pt-24"> {/* Add padding-top to avoid content overlap with the header */}
        <div className="container mx-auto px-6 pb-24 max-w-5xl">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
              Prepare for your dream job with personalized AI interviews that adapt to your industry,
              provide real-time feedback, and help you gain confidence.
            </p>
